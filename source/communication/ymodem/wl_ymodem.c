...
static ymodem_packet_state_t ymodem_receive_package(ymodem_package_t *ptThis,ymodem_ops_t *ptOps,uint8_t chPacketNum)
{
    ...
    switch(this.chState){
        ...
        case READ_HEAD:{
            ...
            ymodem_read_stat_t tFsm = ptOps->fnReadDataWithTimeout(&this.chHead, 1, DLY_3S, DLY_1S);
        ...
        case READ_BLK:{
            ...
            ymodem_read_stat_t tFsm = ptOps->fnReadDataWithTimeout(&this.chBlk, 1, DLY_1S, DLY_1S);        
            if(YMODEM_READ_CPL == tFsm){
        ...
        case READ_NBLK:{
            ...
            ymodem_read_stat_t tFsm = ptOps->fnReadDataWithTimeout(&this.chNBlk, 1, DLY_1S, DLY_1S);    
            if(YMODEM_READ_CPL == tFsm){
        ...
        case READ_CHECK_L:{
            ...
            ymodem_read_stat_t tFsm = ptOps->fnReadDataWithTimeout(&this.chCheck[0], 1, DLY_1S, DLY_1S);           
            if(YMODEM_READ_CPL == tFsm){
        ...
        case READ_CHECK_H:{
            ...
            ymodem_read_stat_t tFsm = ptOps->fnReadDataWithTimeout(&this.chCheck[1], 1, DLY_1S, DLY_1S);   
            if(YMODEM_READ_CPL == tFsm){
    ...
    switch(this.chState){
        ...
        case RECEIVE_PACK_PATH:{
            ...
            if(tPackageState == PACKET_CPL) {
                ...
                if(this.tOps.fnOnFilePath(this.tOps.pchBuffer, &this.tOps.hwSize)){
...
static ymodem_packet_state_t ymodem_send_package(ymodem_package_t *ptThis, ymodem_ops_t *ptOps, uint8_t chPacketNum)
{
    ...
    switch(this.chState){
        ...
        case SEND_HEAD:{
            ...
            if(ptOps->fnWriteData(&this.chHead, 1)) {
        ...
        case SEND_BLK:{
            ...
            if(ptOps->fnWriteData(&this.chBlk, 1)) {
        ...
        case SEND_NBLK:{
            ...
            if(ptOps->fnWriteData(&this.chNBlk, 1)) {
        ...
        case SEND_CHECK_L:{
            ...
            if(ptOps->fnWriteData(&this.chCheck[0], 1)) {
        ...
        case SEND_CHECK_H:{
            ...
            if(ptOps->fnWriteData(&this.chCheck[1], 1)) {
...
fsm_rt_t ymodem_send(ymodem_t *ptThis)
{
    ...
    switch (this.chState) {
        ...
        case RECEIVE_ACK1:{
            ...
            ymodem_read_stat_t tFsm = this.tOps.fnReadDataWithTimeout(&this.chByte,1,DLY_10S,DLY_1S);
            if(YMODEM_READ_CPL == tFsm){
                if(this.chByte == ACK){
        ...
        case RECEIVE_ACK2: {
            ...
            if(YMODEM_READ_CPL == tFsm) {
                ...
                if(this.chByte == ACK) {
                    ...
                    return fsm_rt_cpl; // Return completion status
                } else {
